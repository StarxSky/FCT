...
#
model = ResNet50(ResNet_50_new_Config.model_num_classes,
                 ResNet_50_new_Config.embedding_dim,
                 ResNet_50_new_Config.last_nonlin)

#print(model)
optimizer = get_optimizer(model,
                          ResNet_50_new_Config.optimizer_algorithm,
                          ResNet_50_new_Config.optimizer_lr,
                          ResNet_50_new_Config.weight_decay,
                          ResNet_50_new_Config.momentum,
                          ResNet_50_new_Config.no_bn_decay,
                          ResNet_50_new_Config.nesterov)

lr_policy = get_policy(optimizer)

criterion = LabelSmoothing(ResNet_50_new_Config.label_smoothing)
...
if __name__ == "__main__" :
    main(model,
         data = data,
         model_path=ResNet_50_new_Config.output_model_path,
         criterion=criterion,
         optimizer=optimizer,
         lr_policy=lr_policy,
         epochs=ResNet_50_new_Config.epochs)
